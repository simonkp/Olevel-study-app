(function () {
  window.__registerTopic({
    ...
    {id:"chem-T19-013",question:"Indoor pollutant:",options:["Only O₂","Formaldehyde from furniture VOCs","Only N₂","Helium"],correctIndex:1,explanation:"VOCs."},
    ...
    {id:"chem-T19-017",question:"Eutrophication linked to air via:",options:["Only CO","NOₓ deposition → nitrate in water","Only O₃","Argon"],correctIndex:1,explanation:"Nutrient runoff also major."},
    ...
    {id:"chem-T19-019",question:"WHO air quality guidelines:",options:["Legal everywhere","Health-based targets","Ignore PM","Only CO₂"],correctIndex:1,explanation:"Guidance."},
    ...
    {id:"chem-T19-021",question:"Hydrofluorocarbons vs CFCs:",options:["Same ozone impact","Lower ODP but often high GWP","No GWP","Not gases"],correctIndex:1,explanation:"Trade-offs."},
    {id:"chem-T19-022",question:"Urban heat island:",options:["Rural warmer","City warmer than surroundings","Same T","Only winter"],correctIndex:1,explanation:"Concrete, less evapo."},
    {id:"chem-T19-023",question:"Ocean acidification:",options:["CO₂ → lower pH seawater","SO₂ only","No change","Only freshwater"],correctIndex:0,explanation:"H⁺ from CO₂."},
    {id:"chem-T19-024",question:"Mask effectiveness vs PM₂.₅:",options:["Cloth stops all","N95 better than loose cloth","No filter works","Only outdoors"],correctIndex:1,explanation:"Filtration rating."},
    ...
    {id:"chem-T19-026",question:"Air Quality Index combines:",options:["Only temperature","Several pollutants into index","Only noise","Only humidity"],correctIndex:1,explanation:"Composite."},
