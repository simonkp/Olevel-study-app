(function () {
  window.__registerTopic({
    ...
    {id:"chem-T13-003",question:"Highest first IE Period 3 excluding noble:",options:["Na","Mg","Si","Cl"],correctIndex:3,explanation:"Right before Ar."},
    ...
    {id:"chem-T13-009",question:"Why Al less metallic than Na same period:",options:["More protons hold e⁻ tighter","Fewer protons","Same shielding exactly","Larger radius"],correctIndex:0,explanation:"Effective nuclear charge."},
    ...
    {id:"chem-T13-011",question:"Electron affinity most exothermic halogen:",options:["I","Br","Cl","F"],correctIndex:2,explanation:"F small size — Cl often max in group."},
    ...
    {id:"chem-T13-017",question:"Lanthanide contraction effect:",options:["6d and 5d similar size","No effect","Only s-block","Halogens shrink"],correctIndex:0,explanation:"5d vs 4d."},
    ...
    {id:"chem-T13-021",question:"Ionisation energy Mg vs Al anomaly:",options:["Al lower (3p easier e⁻)","Mg lower","Same","Both zero"],correctIndex:0,explanation:"s² full subshell stable Mg."},
    {id:"chem-T13-022",question:"S₂ molecule (adv):",options:["Like O₂ paramagnetic idea","Single bonded only","Noble","Ionic"],correctIndex:0,explanation:"Disulfur."},
    ...
    {id:"chem-T13-025",question:"Noble gas compound first (history):",options:["Xe compounds","He compounds easy","Ne many","Ar acids"],correctIndex:0,explanation:"XePtF₆."},
    {id:"chem-T13-026",question:"Effective nuclear charge trend across:",options:["Decreases","Increases","Constant","Random"],correctIndex:1,explanation:"Zeff up."},
    ...
    {id:"chem-T13-201",question:"Across Period 3 (Na → Ar), first ionisation energy overall:",options:["Decreases monotonically","Generally increases with dips (e.g. Mg→Al, P→S)","Is constant","Only Mg has an IE"],correctIndex:1,explanation:"General increase across period; known small dips in data."},
    {id:"chem-T13-202",question:"Chlorine has a higher first IE than sulfur mainly because:",options:["S has more protons","Cl’s valence electron is in the same shell but experiences a greater effective nuclear charge","Cl is larger","S is a noble gas"],correctIndex:1,explanation:"Same period — Zeff trend dominates."},
