(function () {
  window.__registerTopic({
    ...
    {id:"chem-T9-009",question:"Nitric acid from ammonia:",options:["Ostwald process","Contact only","Haber only","Electrolysis"],correctIndex:0,explanation:"Oxidation steps."},
    ...
    {id:"chem-T9-015",question:"Biological nitrogen fixation:",options:["Lightning only","Bacteria in legumes","Only Haber","Oceans only"],correctIndex:1,explanation:"Rhizobia."},
    ...
    {id:"chem-T9-022",question:"NH₃ lone pair:",options:["Lewis base","Lewis acid only","No electrons","Only metal"],correctIndex:0,explanation:"Donor."},
    ...
    {id:"chem-T9-031",question:"NH₃ has a lone pair and acts as a Lewis base by:",options:["Accepting a proton or donating an electron pair to an electron-pair acceptor","Losing all electrons","Forming only ionic lattices","Oxidising metals only"],correctIndex:0,explanation:"Lone pair donation defines Lewis basicity."},
    ...
    {id:"chem-T9-036",question:"In Ostwald’s route conceptually, ammonia is oxidised toward:",options:["Diamond","Nitrogen only","Nitric acid (via NO → NO₂)","Helium"],correctIndex:2,explanation:"Industrial oxidation steps to HNO₃."},
