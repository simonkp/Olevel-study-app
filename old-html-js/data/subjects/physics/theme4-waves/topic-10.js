(function () {
    window.__registerTopic({
        ...
        quiz: [
          ...
          { question: "In vacuum, if frequency doubles, wavelength…", options: ["doubles", "halves", "is unchanged", "becomes infinite"], correctIndex: 1, explanation: "c = fλ with constant c ⇒ λ halves when f doubles." },
          { question: "Which has the highest photon energy per quantum (typical syllabus ranking)?", options: ["microwave", "visible", "ultraviolet", "gamma"], correctIndex: 3, explanation: "Higher f → higher energy; gamma is highest f among these." },
          { question: "Medical X-ray imaging relies on X-rays being…", options: ["reflected strongly by skin", "absorbed differently by different tissues", "sound-like", "longitudinal"], correctIndex: 1, explanation: "Contrast comes from different absorption/penetration." },
          { question: "Typical radio waves have wavelength compared with visible light that is…", options: ["much shorter", "much longer", "always equal", "zero"], correctIndex: 1, explanation: "Radio is low f → long λ; visible is much shorter λ." },
          { question: "Two different EM waves in vacuum share the same…", options: ["frequency always", "wavelength always", "speed c", "colour always"], correctIndex: 2, explanation: "All EM waves travel at c in vacuum (syllabus value)." },
          { question: "Sunburn and skin damage from excessive exposure are most associated with…", options: ["radio waves", "microwaves", "high-energy ultraviolet", "sound"], correctIndex: 2, explanation: "UV (especially higher-energy UV) is ionising/damaging to skin." },
          { question: "A TV remote often uses… to send signals.", options: ["gamma rays", "infrared", "X-rays", "ultrasound"], correctIndex: 1, explanation: "Common remotes use IR LEDs." },
          { question: "Sterilising equipment with penetrating radiation in hospitals often uses…", options: ["alpha particles", "beta particles", "gamma rays", "radio waves"], correctIndex: 2, explanation: "Gamma is highly penetrating and used for sterilisation (with precautions)." },
          { question: "Moving from infrared → visible → ultraviolet in the spectrum, frequency…", options: ["decreases", "stays the same", "increases", "becomes zero"], correctIndex: 2, explanation: "That direction is toward higher f (shorter λ)." },
        ],
        trueFalse: [
