(function () {
    window.__registerTopic({
        ...
        quiz: [
          ...
          { question: "After 3 half-lives, the undecayed fraction of nuclei is about…", options: ["1/2", "1/4", "1/8", "1/16"], correctIndex: 2, explanation: "Each half-life halves the remainder: (1/2)³ = 1/8." },
          { question: "¹⁴C and ¹²C are isotopes of carbon. They have the same…", options: ["neutron number", "proton number", "mass number", "nuclear charge sign"], correctIndex: 1, explanation: "Isotopes share Z (protons); differ in neutron count." },
          { question: "An α particle’s charge is best described as…", options: ["−1e", "0", "+1e", "+2e"], correctIndex: 3, explanation: "α is a helium nucleus: two protons ⇒ +2e." },
          { question: "A β⁻ particle is essentially…", options: ["a helium nucleus", "a high-speed electron from the nucleus", "a neutral neutron alone", "visible light"], correctIndex: 1, explanation: "β⁻ emission involves an electron (plus antineutrino, usually not examined numerically)." },
          { question: "Which radiation type is the least penetrating in materials (typical ranking)?", options: ["gamma", "beta", "alpha", "all equal"], correctIndex: 2, explanation: "α is stopped easily (paper/skin); penetration is lowest." },
          { question: "Which is a reason radioactive decay is hard to predict for one nucleus?", options: ["it is non-random", "it is random", "it depends on the day of the week", "it needs sunlight"], correctIndex: 1, explanation: "Decay is probabilistic; exact moment for a given nucleus is random." },
          { question: "Background radiation includes contributions from…", options: ["only classroom lights", "Earth materials, cosmic rays, and some natural radon (context)", "only beta rays from batteries", "only DC circuits"], correctIndex: 1, explanation: "Natural/environmental sources contribute everywhere (basic context)." },
          { question: "For a given isotope, half-life is…", options: ["different for every atom of that isotope", "a constant characteristic of that isotope (usual syllabus model)", "equal to full decay time always", "zero"], correctIndex: 1, explanation: "Half-life is an isotope property (conditions assumed standard)." },
          { question: "Industrial thickness monitoring of thin metal/foil often uses… because absorption depends strongly on thickness.", options: ["alpha", "beta", "gamma only", "sound in vacuum"], correctIndex: 1, explanation: "β is partially absorbed; transmitted intensity changes with thickness." },
          { question: "Ingesting an α-emitter is especially hazardous mainly because…", options: ["α penetrates deep in tissue", "α is highly ionising but stopped inside tissue (high local dose)", "α has infinite range", "α is non-ionising"], correctIndex: 1, explanation: "Short range concentrates ionisation damage locally if taken inside." },
        ],
        trueFalse: [
