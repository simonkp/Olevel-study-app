(function () {
    window.__registerTopic({
        ...
        quiz: [
          ...
          { question: "A particle has u = +6 m/s and a = −2 m/s². How long until v = 0?", options: ["2 s", "3 s", "4 s", "12 s"], correctIndex: 1, explanation: "v=u+at → 0=6−2t → t=3 s." },
          { question: "From rest, uniform a = 4 m/s² for 5 s. Displacement is…", options: ["20 m", "50 m", "100 m", "10 m"], correctIndex: 1, explanation: "s=½at²=0.5×4×25=50 m." },
          { question: "A train slows from 20 m/s to 8 m/s over 240 m. Using v²=u²+2as, a equals…", options: ["−0.6 m/s²", "−1.2 m/s²", "+0.6 m/s²", "−2.4 m/s²"], correctIndex: 0, explanation: "a=(v²−u²)/(2s)=(64−400)/480=−0.6 m/s²." },
          { question: "On a displacement–time graph, a horizontal line means…", options: ["acceleration is zero", "velocity is zero", "speed is infinite", "object must be at x=0"], correctIndex: 1, explanation: "Gradient (velocity) is zero." },
          { question: "From rest, uniform acceleration. Ratio of distance in the 1st second to distance in the 2nd second is…", options: ["1:2", "1:3", "1:4", "3:5"], correctIndex: 1, explanation: "s₁=½a; s₂(total in 2 s)−s₁=2a−½a=3a/2 → first-second : second-second = ½a : 3a/2 = 1:3." },
          { question: "Average velocity over a closed loop (start = finish) is…", options: ["always zero", "always positive", "equal to average speed", "cannot be zero"], correctIndex: 0, explanation: "Displacement is zero, so average velocity = displacement/time = 0." },
          { question: "For motion with constant acceleration, which is NOT always true?", options: ["v–t graph is straight line", "a–t graph is horizontal line", "s–t graph is straight line", "F=ma if mass constant"], correctIndex: 2, explanation: "s–t is parabolic for constant a (unless u=a=0)." },
          { question: "A stone is thrown vertically up at 19.6 m/s (g=9.8). Time to return to the hand is…", options: ["2 s", "4 s", "1 s", "0.5 s"], correctIndex: 1, explanation: "Time up = v/g = 2 s; symmetric so total flight ≈ 4 s." },
          { question: "Two bodies start from rest with accelerations 2 m/s² and 5 m/s². After the same time, their speeds are in the ratio…", options: ["2:5", "4:25", "5:2", "1:1"], correctIndex: 0, explanation: "v=at with same t → v ∝ a → 2:5." },
          { question: "Area under an acceleration–time graph gives…", options: ["displacement", "change in velocity", "final velocity always", "kinetic energy"], correctIndex: 1, explanation: "∫a dt = Δv." },
        ],
        trueFalse: [
