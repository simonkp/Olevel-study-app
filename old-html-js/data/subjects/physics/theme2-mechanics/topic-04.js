(function () {
    window.__registerTopic({
        ...
        quiz: [
          ...
          { question: "A 4 kg trolley and a 2 kg trolley have the same momentum. The heavier one has…", options: ["higher speed", "lower speed", "same speed", "zero kinetic energy"], correctIndex: 1, explanation: "p=mv constant → larger m gives smaller v." },
          { question: "A 2 kg object changes velocity from +6 m/s to −4 m/s. Δp is…", options: ["−20 kg·m/s", "+20 kg·m/s", "−2 kg·m/s", "−10 kg·m/s"], correctIndex: 0, explanation: "Δp=m(v−u)=2(−4−6)=−20 kg·m/s." },
          { question: "Newton’s 3rd law pair for a book on a table: Earth pulls book down; the other force of the pair is…", options: ["table pushes book up", "book pulls Earth up", "book pushes table down", "friction on book"], correctIndex: 1, explanation: "Gravitational pair: book attracts Earth upward with equal magnitude." },
          { question: "On a smooth horizontal surface, a 10 N horizontal push on a 2 kg block gives acceleration…", options: ["20 m/s²", "5 m/s²", "0.2 m/s²", "10 m/s²"], correctIndex: 1, explanation: "Smooth → no friction; a=F/m=10/2=5 m/s²." },
          { question: "If net force doubles and mass halves, acceleration becomes…", options: ["the same", "×2", "×4", "×½"], correctIndex: 2, explanation: "a=F/m → (2F)/(m/2)=4F/m." },
          { question: "Crumple zones in cars increase collision time mainly to…", options: ["increase momentum change", "decrease average force for the same Δp", "reduce mass", "increase kinetic energy"], correctIndex: 1, explanation: "F_avg = Δp/Δt; larger Δt lowers force." },
          { question: "A rocket expels gas backwards. The rocket gains forward momentum because…", options: ["momentum is not conserved", "gas gains opposite momentum to the rocket", "gravity is zero", "density decreases"], correctIndex: 1, explanation: "Newton 3 / momentum: rocket and exhaust form a system." },
          { question: "A parachutist before opening the chute accelerates downward because…", options: ["drag > weight", "weight > drag", "drag = weight", "weight is zero"], correctIndex: 1, explanation: "Net downward force = weight − drag." },
          { question: "At terminal velocity for a falling skydiver, which is true?", options: ["Acceleration = g", "Drag equals weight", "Speed is zero", "No energy is dissipated"], correctIndex: 1, explanation: "No net force → drag balances weight." },
          { question: "Resultant force on a body is always in the same direction as…", options: ["velocity", "displacement", "acceleration", "momentum"], correctIndex: 2, explanation: "F=ma → a and resultant F share direction." },
        ],
        trueFalse: [
