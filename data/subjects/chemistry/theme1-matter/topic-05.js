(function () {
  window.__registerTopic({
    ...
    {question:"Which compound has ionic bonding?",options:["H₂O","NaCl","CO₂","CH₄"],correctIndex:1,explanation:"Ionic bonding forms between metal and non-metal ions."},
    ...
    {question:"In diamond, each carbon atom forms:",options:["1 covalent bond","2 covalent bonds","3 covalent bonds","4 covalent bonds"],correctIndex:3,explanation:"Diamond is a giant covalent structure with each C bonded to four others."},
