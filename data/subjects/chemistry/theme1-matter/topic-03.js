(function () {
  window.__registerTopic({
    ...
    {question:"At the same temperature, which gas diffuses fastest?",options:["O₂","N₂","CO₂","H₂"],correctIndex:3,explanation:"Lighter gas particles move faster on average at the same temperature."},
    {question:"Why does increasing temperature raise the rate of diffusion?",options:["Particles become heavier","Particles move faster on average, so mixing happens quicker","Volume always decreases","Pressure always drops"],correctIndex:1,explanation:"Higher temperature increases average particle speed."},
    ...
    {question:"Which change most increases how quickly particles spread out in a gas?",options:["Lowering temperature","Raising temperature","Increasing particle size","Using a heavier gas"],correctIndex:1,explanation:"Higher temperature means faster particle motion."},
