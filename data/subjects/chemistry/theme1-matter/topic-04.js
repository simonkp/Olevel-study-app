(function () {
  window.__registerTopic({
    ...
    {question:"Which pair has the same number of electrons?",options:["Na atom and Ne atom","Na⁺ and Ne atom","Mg atom and Ne atom","Cl atom and Ar atom"],correctIndex:1,explanation:"Na⁺ has 10 electrons, same as Ne."},
    {question:"A key idea in the modern atomic model is:",options:["Atoms are indivisible solid spheres","Atoms contain a tiny nucleus and electrons","All atoms of an element have the same mass number","Electrons are in the nucleus"],correctIndex:1,explanation:"Modern model includes nucleus and electron shells."},
    {question:"Across a period, first ionisation energy generally:",options:["Decreases","Increases","Stays exactly constant","Becomes zero"],correctIndex:1,explanation:"Stronger nuclear attraction usually makes electrons harder to remove."},
