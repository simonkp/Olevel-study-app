(function () {
  window.__registerTopic({
    ...
    cheatBlocks: [
        ...
        { 
            "title": "Rate vs Final Yield (Graph Interpretation)", 
            "points": [ 
                " **Steepness of the curve**: Indicates the **rate** of reaction. Steeper = faster. Flattens out = reaction stops.",
                " **Height of the plateau**: Indicates the **final yield** (total volume of gas or mass lost).",
                "Changing temperature, catalyst, or particle size changes the **steepness** but NOT the final height.",
                "Changing the **moles of the limiting reactant** changes the **final height**."
            ] 
        }
    ],
    ...
    {id:"chem-T16-012",question: "Excess zinc powder reacts with 50 cm³ of 1.0 mol/dm³ hydrochloric acid. The volume of hydrogen gas is plotted (Curve X). The experiment is repeated using 50 cm³ of 2.0 mol/dm³ hydrochloric acid (Curve Y). How does Curve Y compare to Curve X?",options: ["Curve Y is steeper and reaches the exact same final volume.","Curve Y is less steep and reaches half the final volume.","Curve Y is steeper and reaches double the final volume.","Curve Y has the same steepness but reaches double the final volume."],correctIndex: 2,explanation: "The acid concentration is doubled, which increases the rate (steeper curve). Since the volume of acid is the same, doubling the concentration also doubles the number of moles of the limiting reactant, so double the volume of hydrogen gas is produced (higher plateau)."},
    ...
    {id:"chem-T16-014",question: "In an experiment measuring the mass of a flask during the reaction between calcium carbonate and dilute nitric acid, why does the mass of the flask decrease?",options: ["Calcium carbonate is lighter than calcium nitrate.","The acid evaporates due to the heat of the reaction.","Carbon dioxide gas is produced and escapes from the open flask.","Nitric acid is consumed."],correctIndex: 2,explanation: "The reaction produces CO₂ gas ($CaCO_3 + 2HNO_3 \\rightarrow Ca(NO_3)_2 + H_2O + CO_2$). Because the flask is open, the gas escapes into the atmosphere, causing a measurable loss in mass."},
    {id:"chem-T16-015",question:"Increasing concentration speeds up a reaction mainly because:",options:["Particles have less energy","There are more frequent effective collisions","Activation energy is doubled","A catalyst is formed"],correctIndex:1,explanation:"Higher concentration means more particles in a given volume, increasing the frequency of collisions between reactant particles."},
    ...
    {id:"chem-T16-017",question:"Which statement about catalysts is correct?",options:["They increase reaction yield permanently","They provide a pathway with a lower activation energy","They shift equilibrium to products only","They are always solid metals"],correctIndex:1,explanation:"Catalysts speed up reactions by offering an alternative reaction pathway that requires less activation energy."},
    ...
    extendedQuestions: [
        {
            ...
            marks: 6,
            syllabusNote: "Rate of Reactions - Interpreting graphs and collision theory.",
            prompt: "A student investigates the reaction between magnesium ribbon and excess dilute sulfuric acid by measuring the volume of hydrogen gas collected in a gas syringe every 10 seconds. \n\n(a) Explain, using the Collision Theory, why the rate of reaction is fastest at the beginning and gradually slows down to zero.\n(b) The student repeats the experiment using the same mass of magnesium, but as a fine powder instead of a ribbon. Sketch and describe how the new graph will look compared to the original graph.\n(c) Calculate the average rate of reaction if 48 cm³ of hydrogen gas is collected in the first 60 seconds.",
            rubric: [
                "(a) At the beginning, the **concentration of acid is highest** and the surface area of magnesium is largest.",
                "(a) As the reaction proceeds, reactant particles are consumed, meaning a **lower frequency of effective collisions**.",
                "(a) The rate becomes zero when the **limiting reactant (magnesium) is completely used up**.",
                "(b) The new curve will be **steeper** at the start (faster rate).",
                "(b) The new curve will **level off earlier**, but at the **exact same final volume**.",
                "(c) Average rate = $48 \\div 60$ = **0.80 cm³/s**."
            ],
            modelAnswer: "(a) At the start of the reaction, the concentration of sulfuric acid particles is at its maximum, leading to the highest frequency of effective collisions between $H^+$ ions and magnesium atoms. As the reaction proceeds, the acid is used up, so its concentration decreases. This leads to a lower frequency of effective collisions, slowing the rate. The reaction stops (rate is zero) when all the magnesium (the limiting reactant) has reacted.\n\n(b) The new graph for the magnesium powder will start with a much **steeper gradient**, showing a faster initial rate because the powder has a much larger surface area exposed for collisions. The curve will level off and become flat much sooner, but it will end at the **exact same final volume** of hydrogen gas because the mass of magnesium used was identical.\n\n(c) Average rate = $\\frac{\\text{Total Volume}}{\\text{Time taken}} = \\frac{48 \\text{ cm}^3}{60 \\text{ s}} = 0.80 \\text{ cm}^3/\\text{s}$."
        }
    ],
    trueFalse: [
