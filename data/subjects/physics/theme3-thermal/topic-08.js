(function () {
    window.__registerTopic({
        ...
        quiz: [
          ...
          { question: "A metal spoon in hot soup feels hot mainly because heat travels along the spoon by…", options: ["convection in the metal", "conduction", "radiation only", "evaporation"], correctIndex: 1, explanation: "Solids: lattice/electron conduction." },
          { question: "Putting a lid on a saucepan reduces heat loss mainly by limiting…", options: ["conduction through metal", "convection and evaporation of steam", "radiation from Earth", "sound"], correctIndex: 1, explanation: "Traps warm moist air; reduces convection out." },
          { question: "The Sun’s heat reaches Earth through…", options: ["conduction through space", "convection in space", "radiation", "conduction in air only"], correctIndex: 2, explanation: "Vacuum: only radiation." },
          { question: "A thermos flask’s silvered inner walls mainly reduce…", options: ["conduction across vacuum", "convection in vacuum", "radiation", "gravity"], correctIndex: 2, explanation: "Reflect IR to reduce radiative transfer." },
          { question: "Foam insulation works well partly because trapped air…", options: ["conducts heat very well", "is a poor conductor / stops convection", "emits lots of IR", "is very dense"], correctIndex: 1, explanation: "Air pockets limit conduction/convection." },
          { question: "Night-time land breeze (sea warmer than land) happens because…", options: ["water always has lower specific heat", "cool dense air over land sinks and sea air moves in", "radiation stops at night", "convection cannot occur"], correctIndex: 1, explanation: "Pressure/density-driven convection opposite to day sea breeze." },
          { question: "A white car stays cooler in sun than a black one mainly because white paint…", options: ["conducts better", "reflects more visible/IR", "emits no radiation", "increases convection"], correctIndex: 1, explanation: "Lower absorption of incident solar radiation." },
          { question: "Sitting near a campfire feels hot even when cold air blows past because…", options: ["conduction from smoke", "radiated IR from hot coals", "convection in solids", "latent heat of wood"], correctIndex: 1, explanation: "Line-of-sight IR radiation." },
          { question: "Double glazing reduces U-value mainly by…", options: ["thickening glass only", "trapped air/gas gap reducing conduction and convection", "painting black", "increasing pressure"], correctIndex: 1, explanation: "Air layer is insulating." },
          { question: "A vacuum in a flask stops conduction and convection because…", options: ["IR cannot pass", "there are no material particles to carry energy", "silver reflects sound", "heat capacity is infinite"], correctIndex: 1, explanation: "No medium for particle transfer." },
        ],
        trueFalse: [
